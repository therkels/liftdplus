-- User Types
INSERT INTO UserType (type_id, descr) VALUES
('admin', 'Internal Team Administrator'),
('regular', 'Regular User');

-- Users (Admin only for MVP)
INSERT INTO Users (UUID, username, email, user_type_id) VALUES
('u1', 'kenyaa', 'kenya.a@example.com', 'admin'),
('u2', 'liftdplus', 'team@liftdplus.com', 'admin');

INSERT INTO PostTemplate (id, descr, has_html, has_json) VALUES
...
INSERT INTO PostType (post_type_id, template_id, descr) VALUES
...
INSERT INTO Category (ID, short_desc) VALUES
('sleep', 'Sleep & Rest'),
('anxiety', 'Stress & Anxiety'),
('intimacy', 'Intimacy');

-- Tags: Each tag links to a category + additional tag for Content Type, Audience
INSERT INTO Tag (ID, label_id, display_name, descr) VALUES
...
-- Micro Story
INSERT INTO Post (UUID, post_template_id, author, contributor_name, source, post_status, markup, config)
VALUES (
...
INSERT INTO PostTag (post_uuid, tag_id) VALUES
('p1', 't1'),
('p1', 'ct_micro_story'),
('p1', 'aud_parents');
...
INSERT INTO Likes (user_uuid, post_uuid) VALUES
('u1', 'p1'),
('u1', 'p4');
