...
export default function ArticleDetailCTA() {
  return (
    <section className="mt-16 border-t border-[#cdcec7] pt-12">
      <div className="rounded-lg bg-[#f4f7f5] p-8 text-center lg:p-10">
        ...
        <Link
          href="/onboarding"
          className="inline-flex items-center gap-2 rounded bg-[#6b938c] px-6 py-3 font-semibold text-white transition-colors duration-200 hover:bg-[#5a7d75] no-underline"
        >
